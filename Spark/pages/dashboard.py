...
class DashboardPage(ctk.CTkFrame):
    ...
    def draw_weekly_chart(self, parent):
        """Рисует график активности с помощью Canvas"""
        # Очищаем ТОЛЬКО старый график (Canvas), чтобы не удалить заголовок
        ...
        for i in range(7):
            ...
            if heights[i] == 0:
                canvas.create_rectangle(x0, 138, x1, y1, fill="#A0A0A0", outline="")
            else:
