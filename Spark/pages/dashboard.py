...
class DashboardPage(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        ctk.CTkLabel(self.actions_box, text=f"{localization.get('quick')} \n {localization.get('actions')}", font=("Inter", 32), text_color="black").pack(pady=(7,7))
    ...
    def show_add_book_modal(self):
        ...
        self.modal_frame = ctk.CTkFrame(self.right_container, width=797, height=597, fg_color="#E8E8E8", corner_radius=9, border_width=1, border_color="#B0B0B0")
